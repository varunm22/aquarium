...
export function world3DToWall2D(pos, wall) {
    switch (wall) {
        case 'front':
        case 'back':
...
export function wall2DToWorld3D(wallPoint, wallOffset) {
...
export function wall2DToWorld3DVelocity(wallPoint) {
    switch (wallPoint.wall) {
        case 'front':
        case 'back':
...
export function getWall2DBounds(wall) {
    const bounds = getTankBounds();
    switch (wall) {
        case 'front':
        case 'back':
...
export function getOppositeWall(wall) {
    switch (wall) {
...
export function getAdjacentWalls(wall) {
    const connections = {
